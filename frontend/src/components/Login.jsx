    ...
    <div className="auth-container fade-in">
      <div className="glass-panel auth-card">
        <div className="auth-header">
          ...
          <h1 className="auth-title">AquaCheck</h1>
          <p style={{color: 'var(--text-muted)'}}>AI Water Quality Analysis</p>
        </div>
        ...
        <button onClick={handleGoogleAuth} className="btn btn-google" style={{width: '100%'}} disabled={loading}>
